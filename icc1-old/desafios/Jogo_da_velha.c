...
int main () {
	int v[3][3] = {0};  //inicia todas as posições com zero
	int i, j;
	int x = 0;
	...
	while(x==0){
		...
		else if((v[2][0]==v[1][1])&&(v[2][0]==v[0][2])&&(v[2][0]==1)){
        	printf("Jogador 1 venceu!\n");
        	x++;
		}
		else if((v[0][0]==v[0][1])&&(v[0][0]==v[0][2])&&(v[0][0]==1)){
        	printf("Jogador 1 venceu!\n");
        	x++;
		}
		else if((v[1][0]==v[1][1])&&(v[1][0]==v[1][2])&&(v[1][0]==1)){
        	printf("Jogador 1 venceu!\n");
        	x++;
		}
		else if((v[2][0]==v[2][1])&&(v[2][0]==v[2][2])&&(v[2][0]==1)){
        	printf("Jogador 1 venceu!\n");
        	x++;
    	}
    	else if((v[0][0]==v[1][0])&&(v[0][0]==v[2][0])&&(v[0][0]==1)){
        	printf("Jogador 1 venceu!\n");
        	x++;
    	}
    	else if((v[0][1]==v[1][1])&&(v[0][1]==v[2][1])&&(v[0][1]==1)){
        	printf("Jogador 1 venceu!\n");
        	x++;
    	}
    	else if((v[0][2]==v[1][2])&&(v[0][2]==v[2][2])&&(v[0][2]==1)){
        	printf("Jogador 1 venceu!\n");
        	x++;
    	}
        ...
        if((v[0][0]==v[1][1])&&(v[0][0]==v[2][2])&&(v[0][0]==2)){
        	printf("Jogador 2 venceu!\n");
        	x++;
		}
		else if((v[2][0]==v[1][1])&&(v[2][0]==v[0][2])&&(v[2][0]==2)){
        	printf("Jogador 2 venceu!\n");
        	x++;
		}
		else if((v[0][0]==v[0][1])&&(v[0][0]==v[0][2])&&(v[0][0]==2)){
        	printf("Jogador 2 venceu!\n");
        	x++;
		}
		else if((v[1][0]==v[1][1])&&(v[1][0]==v[1][2])&&(v[1][0]==2)){
        	printf("Jogador 2 venceu!\n");
        	x++;
		}
		else if((v[2][0]==v[2][1])&&(v[2][0]==v[2][2])&&(v[2][0]==2)){
        	printf("Jogador 2 venceu!\n");
        	x++;
    	}
    	else if((v[0][0]==v[1][0])&&(v[0][0]==v[2][0])&&(v[0][0]==2)){
        	printf("Jogador 2 venceu!\n");
        	x++;
    	}
    	else if((v[0][1]==v[1][1])&&(v[0][1]==v[2][1])&&(v[0][1]==2)){
        	printf("Jogador 2 venceu!\n");
        	x++;
    	}
    	else if((v[0][2]==v[1][2])&&(v[0][2]==v[2][2])&&(v[0][2]==2)){
        	printf("Jogador 2 venceu!\n");
        	x++;
    	}
    }
